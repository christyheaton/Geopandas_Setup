...
* To open the Jupyter Notebook included in this tutorial, in your Anaconda prompt navigated to the Notebook directory, type in:

```bash
jupyter notebook
```

This will open a browser where you can click and see the Notebook. Run the first cell to test that setup occured correctly.
